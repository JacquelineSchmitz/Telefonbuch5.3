...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // TODO
    private val _completedAction = MutableLiveData<Boolean>()
    val completedAction: LiveData<Boolean>
    get() = _completedAction
